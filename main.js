...
global.owner = ['628819547416','6285807174320'] // Put your number here
global.mods = ['628819547416','6285807174320'] // Want some help?
global.prems = ['628819547416','6285807174320'] // Premium user has unlimited limit
  ...
  try {
    ...
    let user = global.DATABASE._data.users[m.sender]
      ...
      let _prefix = plugin.customPrefix ? plugin.customPrefix : conn.prefix ? conn.prefix : global.prefix
        ...
        if (plugin.register && user.registered == true) { // Butuh daftar?
          fail('unreg', m, this)
          continue
        }
        ...
        try {
          ...
          if (m.limit) m.reply(+ m.limit + ' Limit terpakai, jangan nyepam anjing😠')
        }
  			break
  		}
  	}
...
conn.welcome = 'Asikkk yang barusan lahir🥳 @user Selamat datang di grup @subject💖 semoga dapet doi😀'
